...
docker_setup_db() {
	...
	mysql --user=root --password=$MYSQL_ROOT_PASSWORD < /tmp/Test.sql
	
	mysql --user=root --password=$MYSQL_ROOT_PASSWORD < /tmp/joomla_db.sql
...
_main() {
	...
	MYSQL_ROOT_PASSWORD="UW£SQLPa55w0rd"
